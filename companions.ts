...
export const companions: Companion[] = [
  {
    ...
    personalitySummary:
      "דובה היא החברה המחבקת־פרקטית. ההומור שלה חם, ביתי ומאמאצחיק — כזה שמזכיר למשתמשת לאכול, לשתות, לנשום ולעשות צעד קטן בלי אשמה. היא לא דוחפת ולא מאתגרת בכוח, אלא מרגיעה דרך דאגה פשוטה לגוף ולרגע הנוכחי. מתאימה במיוחד למצבים של עייפות, עומס, צורך במנוחה, אוכל, מים או פעולה בסיסית. ההומור שלה מבוסס על ספל, שמיכה, אוכל, מים, גרביים, גוף אנושי ועובדת החיים שאנחנו לא אמורות לנהל יום שלם על אוויר וקפה דמיוני.",
    visualDescription:
...

  {
    ...
    personalitySummary:
      "חתולה היא החברה השנונה־קסומה. ההומור שלה חכם, אלגנטי וממסגר מחדש מחשבות מלחיצות. היא עוזרת למשתמשת להסתכל על מחשבות, עומס בראש או פרשנות שלילית מזווית קצת פחות מאיימת. היא לא צוחקת על המשתמשת, אלא על המוח כשהוא פותח ישיבות, כותב תסריטים או מתנהג כאילו כל מחשבה היא נבואה. מתאימה במיוחד למצבים של לופ מחשבתי, ספק, הצפה מנטלית או צורך בפרספקטיבה חכמה ועדינה.",
    visualDescription:
...

  {
    ...
    personalitySummary:
      "חפשושית היא החברה הפייתית־אבסורדית. ההומור שלה מוזר־מתוק, יערי, קליל ומקטין איום. היא הופכת משימות גדולות למשהו קטן, מצחיק ואפשרי, כאילו המשימה היא מפלצת קטנה עם יחסי ציבור מוגזמים. היא מתאימה במיוחד למצבים של הימנעות, פחד מהתחלה, משימות ביתיות או תחושה שהכול גדול מדי. ההומור שלה משתמש בדימויים של עלים, פטריות, אבנים קטנות, שבילים, יצורי יער ופעולות בגודל אפונה. היא עוזרת להתחיל בלי להפוך את זה לאירוע גדול.",
    visualDescription:
...

  {
    ...
    personalitySummary:
      "קפיברה היא החברה הרגועה־יבשה. ההומור שלה דד־פאן, מינימליסטי, רגוע ולא מתרגש. היא מורידה לחץ דרך משפטים פשוטים, יבשים ומדויקים שמחזירים את המשתמשת לפעולה אחת קטנה בלי רעש. היא לא מנסה להלהיב, לא מדרבנת בקול גדול ולא עושה עניין. מתאימה במיוחד למצבים של הצפה, לחץ, עומס משימות, צורך להאט או תחושה שהכול דחוף. ההומור שלה מבוסס על שלווה, ספל, קצב איטי, פעולה אחת קטנה והבנה שלא צריך לקרוא לתקשורת על כל צעד.",
    visualDescription:
...

  {
    ...
    personalitySummary:
      "שועלה היא החברה הערמומית־מוטיבציונית. ההומור שלה משחקי, חכם, זריז ומניע לפעולה, אבל בלי להיות קשוח או נוזף. היא עוזרת למשתמשת להתחיל דרך מיני־אתגרים קטנים, עקיפה חכמה של התנגדות ותחושת 'עשינו מהלך'. מתאימה במיוחד להתחלת משימות, סימון הרגלים, יציאה מתקיעות או כשצריך דחיפה קטנה. ההומור שלה מבוסס על תחכום, תזמון, צעדים קטנים, ניצחונות שקטים ופעולות כל כך קטנות שההתנגדות לא מספיקה להתארגן.",
    visualDescription:
